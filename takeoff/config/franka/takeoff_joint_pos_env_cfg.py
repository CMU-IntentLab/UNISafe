...
from takeoff.takeoff_env_cfg import TakeoffEnvCfg
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        ...
        mode="startup",
        params={
            "default_pose": [0.0648, -0.0311, -0.0581, -2.6653,  0.2607,  2.8246,  0.6610, 0.0400, 0.0400],
        },
    )
...
@configclass
class FrankaTakeoffEnvCfg(TakeoffEnvCfg):
