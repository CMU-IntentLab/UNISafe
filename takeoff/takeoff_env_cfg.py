...
class RewardsCfg:
	...
	failure = RewTerm(
			func=mdp.is_failure, weight = -10
	)

	success = RewTerm(
			func=mdp.is_success, weight = 10
	)
	...
	dist_12 = RewTerm(
		func=mdp.rel_pos_12, weight=5 #0.5
	)
...
class TerminationsCfg:
	...
	success = DoneTerm(func=mdp.is_success)
	failure = DoneTerm(func=mdp.is_failure)
